...
import IndicatorManager from "./components/manager/Indicator";
import EvaluationManager from "./components/manager/Evaluation";
import ReportManager from "./components/manager/Report";
  ...
  <div>
    ...
    <Layout>
      <Switch>
        ...
        <Route exact path="/login" component={Login} />
        //Changes below
        <Route exact path="/indicator" component={withAuth(IndicatorManager)} />
        <Route
          exact
          path="/evaluation"
          component={withAuth(EvaluationManager)}
        />
        <Route exact path="/report" component={withAuth(ReportManager)} />
      </Switch>
    </Layout>
    <Footer />
  </div>
