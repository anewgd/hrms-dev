...
export default class Payment extends Component {
  ...
  onSubmit = (event) => {
    ...
    let newPayment = {
      ...
      paymentAmount: this.state.netSalary - this.state.paymentFine,
                  ...
                  <Card.Text>
                    <Form onSubmit={this.onSubmit}>
                      ...
                      <Form.Group>
                        ...
                        <Form.Control
                          type="number"
                          value={this.state.netSalary - this.state.paymentFine}
                          onChange={this.handleChange}
                          name="paymentAmount"
                          readOnly
                        />
                          ...
                          },
                          {
                            ...
                            render: (rowData) =>
                              new Intl.NumberFormat("en-ET", {
                                ...
                                rowData.job.user.user_financial_info.grossSalary
                              ),
                          },
                          {
                            ...
                            render: (rowData) =>
                              new Intl.NumberFormat("en-ET", {
                                ...
                                rowData.job.user.user_financial_info
                                  .totalDeduction
                              ),
                          },
                          {
                            title: "Net Salary",
                            //field: "job.user.user_financial_info.netSalary",
                            render: (rowData) =>
                              new Intl.NumberFormat("en-ET", {
                                style: "currency",
                                currency: "ETB",
                              }).format(
                                rowData.job.user.user_financial_info.netSalary
                              ),
                          },
                          {
